...
```{r, echo=FALSE}
knitr::include_url("widgets/WGI_DT.html", height = "600px")
```
...
knitr::include_url("widgets/WGI_2021.html", height = "600px")
```
...
knitr::include_url("widgets/Top_3_Comparison.html", height = "600px")
```
...
knitr::include_url("widgets/USA_Plotly.html", height = "500px")
```
